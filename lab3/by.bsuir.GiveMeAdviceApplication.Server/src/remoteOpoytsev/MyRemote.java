...
public interface MyRemote extends Remote {
	...
	DefaultTableModel getComments(int postID) throws RemoteException,
			SQLException;
	...
	void blockingUser(int userId, boolean state) throws RemoteException,
			SQLException;
	...
	void setPass(String username, String password) throws RemoteException,
			SQLException;

	boolean isPass(String username, String password) throws RemoteException,
			SQLException;

	DefaultTableModel getBlocked() throws RemoteException, SQLException;
